...
DISCIPLINE_RE_MAP = {  # patterns within each discipline are ordered by precedence
    'road': [
        ...
        ['circuit', re.compile('circuit|barton|dirty circles|kings valley|montinore|piece of cake|tabor|(monday|tuesday)( night)? pir|champion( thursday|ship raceway)|banana belt', flags=re.I)],
